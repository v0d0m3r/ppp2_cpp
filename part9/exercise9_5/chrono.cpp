...
bool is_date(int y, Month m, int d)
{
    ...
    int days_in_month = 31; // В месяце не более 31го дня
    switch (m) {
    case Month::feb:
...
{
    // ...
    return 0; // Чтобы не было предупреждений
}
...
{
    return Day::sunday; // Чтобы не было предупреждений
}
...
{
    return d; // Чтобы не было предупреждений
}
